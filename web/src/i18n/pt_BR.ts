...
export const ptBR: Record<string, string> = {
  ...
  "matches.col.outcome": "Resultado",
  "matches.col.turns": "Turnos",
  "matches.col.elo": "ELO Δ",
  "matches.draw": "empate",
  "matches.outcome.win": "Vitória",
  "matches.outcome.loss": "Derrota",
  "matches.outcome.draw": "Empate",
  "matches.summary.played": "Jogadas",
  "matches.summary.wins": "Vitórias",
  "matches.summary.losses": "Derrotas",
  "matches.summary.draws": "Empates",
  "matches.summary.netElo": "ELO líquido",
  "matches.summary.winRate": "{{rate}}% de vitórias",
