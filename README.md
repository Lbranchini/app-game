...
Jogo mobile (Android + iOS) de batalhas estratégicas por turnos 3v3, ambientado em **personagens clássicos da história e das mitologias mundiais** (grega, nórdica, egípcia, japonesa, asteca, africana, mesopotâmica, britânica e mais).

## Pitch em uma frase

> Em uma era em que a humanidade parou de acreditar, lendas esquecidas duelam num plano entre mundos pelas últimas faíscas de fé que as mantêm existindo — e você é o **Convocador** que escolhe quais histórias serão lembradas.
...
**Mecânicas de jogo** (turnos, custos de essência, cooldowns, formação 3v3, status effects) são padrão do gênero turn-based tático e não são protegidas por copyright — podem ser livremente usadas e referenciadas.
...
| [`docs/08-narrativa.md`](docs/08-narrativa.md) | Lore: a Ágora, o Mythos, o Convocador |
